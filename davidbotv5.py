...
async def on_ready():
    ...
    while True:
        await asyncio.gather(
            role.edit(colour=red),
            member.edit(nick=names[0])
        )
        await asyncio.sleep(1)
        await asyncio.gather(
            role.edit(colour=orange),
            member.edit(nick=names[1])
        )
        await asyncio.sleep(1)
        await asyncio.gather(
            role.edit(colour=yellow),
            member.edit(nick=names[2])
        )
        await asyncio.sleep(1)
        await asyncio.gather(
            role.edit(colour=green),
            member.edit(nick=names[3])
        )
        await asyncio.sleep(1)
        await asyncio.gather(
            role.edit(colour=blue),
            member.edit(nick=names[4])
        )
        await asyncio.sleep(1)
        await asyncio.gather(
            role.edit(colour=purple),
            member.edit(nick=names[5])
        )
        await asyncio.sleep(1)
        await asyncio.gather(
            role.edit(colour=red),
            member.edit(nick=names[6])
        )
        await asyncio.sleep(1)
